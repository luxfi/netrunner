...
VERSION_2_DIR=/tmp/node-${VERSION_2}/
if [ ! -f ${VERSION_2_DIR}/node ]
then
...
then
    git clone https://github.com/luxdefi/subnet-evm/ $SUBNET_EVM_REPO
fi
...
--node-path-1=${VERSION_1_DIR}/node \
--node-path-2=${VERSION_2_DIR}/node
