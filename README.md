...
# You can use 127.0.0.1:9630/v1/chain/timestamp or 127.0.0.1:9630/v1/chain/E8isHenre76NMxbJ3munSQatV8GoQ4XKWQg9vD34xMBqEFJGf
curl -X POST --data '{
    "jsonrpc": "2.0",
    ...
    "id": 1
}' -H 'content-type:application/json;' 127.0.0.1:9630/v1/chain/timestamp
```
